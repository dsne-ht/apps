...
app.whenReady().then(() => { initDB(); autoBackupDB(path.join(app.getPath('userData'), 'dsne_cm.db'), 'dsne-cm'); createWindow(getStartPage()); autoUpdater.checkForUpdatesAndNotify(); });
